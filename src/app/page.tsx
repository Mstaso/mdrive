...
const getFoldersByParent = (parentId: string) =>
  mockFolders.filter((f) => f.parent === parentId);
const getFilesByParent = (parentId: string) =>
  mockFiles.filter((f) => f.parent === parentId);
        ...
        <div className="flex flex-1 flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-auto p-4">
            <div className="space-y-2">
              {/* List folders */}
              {getFoldersByParent(currentFolder).map((folder) => (
                <FolderRow
                  key={folder.id}
                  folder={folder}
              ...
              {/* List files */}
              {getFilesByParent(currentFolder).map((file) => (
